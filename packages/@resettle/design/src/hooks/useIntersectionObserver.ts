 ...
 * @returns The ref callback, a boolean indicating if the element is intersecting, and the intersection observer entry
 * @example
 * ```tsx
 * // Example 1
...
export function useIntersectionObserver({
  ...
  const callbackRef =
    React.useRef<UseIntersectionObserverOptions['onChange']>(onChange)
